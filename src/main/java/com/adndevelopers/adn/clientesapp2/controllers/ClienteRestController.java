package com.adndevelopers.adn.clientesapp2.controllers;
...
import com.adndevelopers.adn.clientesapp2.models.services.IClienteService;
import com.adndevelopers.adn.clientesapp2.models.services.IUploadFileService;
...
public class ClienteRestController {
	...
	public ResponseEntity<?> show(@PathVariable Long id) {
		...
		if (cliente == null) {
			response.put("mensaje", "El cliente con el ID ".concat(id.toString().concat(" no esta registrado!")));
	...
	private ResponseEntity<?> create(@Valid @RequestBody Cliente cliente, BindingResult result) {
		...
		try {
			...
			response.put("mensaje", "Error registrar el cliente.");
			response.put("error", e.getMessage().concat(": ".concat(e.getMostSpecificCause().getMessage())));
			return new ResponseEntity<Map<String, Object>>(response, HttpStatus.INTERNAL_SERVER_ERROR);
		}
	...
	public ResponseEntity<?> update(@Valid @RequestBody Cliente cliente, BindingResult result, @PathVariable Long id) {
		...
		if (clienteActual == null) {
			response.put("mensaje",
					"No se puede editar el cliente con el ID ".concat(id.toString().concat(" no esta registrado!")));
			return new ResponseEntity<Map<String, Object>>(response, HttpStatus.NOT_FOUND);
		}
